        ...
        <Layout title="Portfolio - Fakad Infotech">
            <Container className="heading-portfolio">
                ...
                <Col md={4} className="mb-4">
                        <Card>
                            <Card.Body>
                                <Card.Title><HiOutlineDocumentText /> Fakad Infotech Centre Application</Card.Title>
                                <Card.Text>
                    ...
                    <Col md={4} className="mb-4">
                        <Card>
                            <Card.Body>
                                <Card.Title><HiOutlineDocumentText /> Fakad Inotech Centre Application API</Card.Title>
                                <Card.Text>
                                The Fakad Infotech Centre Application is a RESTful API built using Node.js and Express.js.
                                </Card.Text>
                    ...
                    <Col md={4} className="mb-4">
                        <Card>
                            <Card.Body>
                                ...
                                <a href="https://handcrafted-haven-tau.vercel.app" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Visit Website</a>
                            </Card.Body>
                        </Card>
                    </Col>
